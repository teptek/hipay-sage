<?php
/*
Template Name: Documentation FR
*/
?>
...
<div class="container">
    ...
    <div class="col-md-7 articles-feed">
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'operation_bourse',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'infos_trimestriels',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'resultats_financiers',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'autres_communiques',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'assemblee_generale',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
        ...
        {
            $args = array( 'post_type' =>   'post',
                'category_name' =>    'operation_titres',
                'posts_per_page' =>  10,
                'paged' =>  $paged   );
